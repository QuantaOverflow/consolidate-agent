...
class Settings(BaseSettings):
    ...
    knowledge_processed_index_path: str = Field(
        default="./outputs/knowledge-processed-index.json",
        alias="KNOWLEDGE_PROCESSED_INDEX_PATH",
    )
    ...
    @property
    def knowledge_processed_index(self) -> Path:
        return Path(self.knowledge_processed_index_path).expanduser()
